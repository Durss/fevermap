...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
    ...
    <body>
		<center>
			...
			<div id="section"><b>Îles incomplètes :</b> <?php echo $notComplete0." (".floor(($notComplete0)/100)."%)"; ?></div>
			...
			<div id="section"><b>Îles repertoriées :</b> <?php echo $submitted1." (".floor(($submitted1)/14400 * 100)."%)"; ?></div>
			<div id="section"><b>Îles incomplètes :</b> <?php echo $notComplete1." (".floor(($notComplete1)/14400 * 100)."%)"; ?></div>
			<div id="section"><b>Îles Nettoyées :</b> <?php echo $cleaned1." (".floor(($cleaned1)/14400 * 100)."%)"; ?></div>
